...
<html>
<head>
    <title>阴道瘙痒-重庆华西妇科医院</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/Lstyle.css" type="text/css" />
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-1.7.2.min.js" ></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.SuperSlide.2.1.2.js" ></script>
    <style>
        .article_body{line-height: 35px;}
    </style>
</head>
<body>
<!--公共页开始-->
...
<div class="content">
    ...
    <div class="article_fl">
        <div class="article_top">
            <h4 class="crumbs">病种</h4>
        </div>
        <div class="article_title">
            <h3>${content_2.title}</h3>
        </div>
        ...
        <div class="article_bottom">
            <a href="ZiXun.html" target="_blank">本文未解决您的问题？点此免费在线咨询</a>
        </div>
    </div>
    <!--中部内容公共框架结束-->
